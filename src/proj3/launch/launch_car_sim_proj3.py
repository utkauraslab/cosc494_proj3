...
def generate_launch_description():
  ...
  proj2_share = get_package_share_directory("proj2")
  proj3_share = get_package_share_directory("proj3")
  ...
  proj2_param = LaunchConfiguration("proj2_param")
  proj3_param = LaunchConfiguration("proj3_param")
  ...
  default_proj2_param = os.path.join(proj2_share, "config", "parameters_ros2.yaml")
  default_proj3_param = os.path.join(proj3_share, "config", "parameters_control.yaml")
  ...
  return LaunchDescription(
      [
          ...
          DeclareLaunchArgument("initial_theta", default_value="0.0", description="Initial heading"),
          DeclareLaunchArgument("xacro_file", default_value=default_xacro),
          DeclareLaunchArgument("use_rviz", default_value="true"),
          DeclareLaunchArgument("rviz_config", default_value=default_rviz),
          DeclareLaunchArgument("map_file", default_value=default_map),
          DeclareLaunchArgument("proj2_param", default_value=default_proj2_param),
          DeclareLaunchArgument("proj3_param", default_value=default_proj3_param),
